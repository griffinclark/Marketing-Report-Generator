...
def get_company_description(web_text):
    logging.info("Understanding what your company does...")
...
def describe_user_problem(user_input):
    logging.info("Understanding the problem...")
    res = openai.ChatCompletion.create(
...
def generate_hypothesis(web_copy):
    logging.info("Thinking up a hypothesis...")
...
def generate_test():
    logging.info("Generating ideas to test the hypothesis...")
...
def figure_out_what_we_can_expect_to_learn():
    logging.info("Making sure the test fits with what we want to learn...")
...
def how_to_perform_test():
    logging.info("Writing a guide for performing this test...")
...
def generate_title():
    logging.info("Prepping the report...")
    res = openai.ChatCompletion.create(
        model=fast_model,
        messages=[
